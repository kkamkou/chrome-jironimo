...
https://cdn.jsdelivr.net/lodash/4.17.2/lodash.min.js;vendors/lodash/lodash-latest.js
https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.17.0/moment.min.js;vendors/momentjs/moment-latest.js
EOL`
