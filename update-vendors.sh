...
https://code.jquery.com/jquery-3.1.0.min.js;vendors/jquery/jquery-latest.js
https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.min.js;vendors/less/less-latest.js
https://cdn.jsdelivr.net/lodash/4.15.0/lodash.min.js;vendors/lodash/lodash-latest.js
https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.15.0/moment.min.js;vendors/momentjs/moment-latest.js
EOL`
